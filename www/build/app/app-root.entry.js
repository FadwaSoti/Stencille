        ...
        return (h("div", null,
            ...
            h("main", null,
                h("stencil-router", null,
                    h("ul", { id: "menu-demo" },
                        h("li", null,
                            h("a", { href: "/home/stencil" }, "Accueil")),
                        h("li", null,
                            h("a", { href: "/add/stencil" }, "Nouveau article"))),
                    h("stencil-route-switch", { scrollTopOffset: 0 },
                        h("stencil-route", { url: '/', component: 'app-home', exact: true }),
                        h("stencil-route", { url: '/home/stencil', component: 'app-home' }),
                        h("stencil-route", { url: '/add/stencil', component: 'app-add' }),
                        h("stencil-route", { url: '/detail/stencil', component: 'app-detail' }),
                        h("stencil-route", { url: '/fetch/:name', component: 'app-fetch-id', exact: true }))))));
    }
    static get is() { return "app-root"; }
    static get encapsulation() { return "shadow"; }
    static get style() { return "header {\n  background: #ff3333;\n  color: white;\n  height: 56px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26);\n  box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26);\n  \n}\n\nh1 {\n  font-size: 1.4rem;\n  font-weight: 500;\n  color: #fff;\n  padding: 0 850px;\n}\n\n#menu-demo li {\n  \n  list-style:none;\n  padding: 16px;\n  width: 15%;\n  background-color: #ff3333;;\n}\n#menu-demo li a {\n  text-decoration: none; \n  color: #f8fafc;\n  font-weight: bold;\n  padding: 0 40px;\n}\n\n#menu-demo li a:hover {\n  text-decoration: underline;\n  color: white;\n}\n\n#menu-demo li:hover {\n  background: #383737 url(\"star.png\") no-repeat scroll left center;\n  width: 17%;\n}"; }
}
